...
//{
    ...
    $.fn.customselect = function (method, value) {
        ...
        var $options = {
          ...
          //  "emptytext": true,               // Change empty option text to a set value
                    ...
                    var setup = {
                       ...
                       debugger
                        ...
                        subcontainer: function () {
                            debugger
                            // Container
                            var subcont = $("<div id='maindiv'/>").appendTo($this);
                          
                            // Input Box
                            var input = $("<input type='input' class='form-control'/>").appendTo(subcont);
                            ...
                            // Selectable Items
                            var select = $("<ul class='uhj'/>").appendTo(scroll);
