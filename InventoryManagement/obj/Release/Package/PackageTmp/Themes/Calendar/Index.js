$(document).ready(function () {
    ...
    //    //$.ajax
    //    //({
    //    //    url: '/Hotel_employee/Employee/AsyncUpdateCalender',
    //    //    type: 'GET',
    //    //    traditional: true,
    ...
    //    //            $("#tab_9 #component-header").empty();
    //    //            $("#tab_9 #component-header").append(newHeader);
    ...
    //    //            $("#tab_9 #component-table").trigger("update");
    //    //        } else {
...
function ApplyCalenderData(dt)
{

    var object = $(dt).attr("id");
    var str = object.split('/');
   // alert(str[0]); //contains "month"
   // alert( str[1]); //contains "year"
    var S_grp_id = $('#Shift_Groupid').val(); 
    var E_grp_id = $('#Category_Id').val();
    alert($('#Dhift_Roasterid').val());
    alert(dt);
    alert("hi");
  //  alert(S_grp_id); alert(E_grp_id);
    ...
    ({
        ...
        success: function (result) {
            if (!jQuery.isEmptyObject(result)) {
                ...
                var week6 = $("#week6");
                week6.empty();
                var newHeader = $('<a id=' + result.prevMonth + ' class="month prev" style="float:left" onclick="ApplyCalenderData(this);">&nbsp;&nbsp;&nbsp;Prev</a>' + getMonth(str[0]) + ' ' + str[1] + '<a id=' + result.nextMonth + ' class="month next" style="float:right" onclick="ApplyCalenderData(this);">Next&nbsp;&nbsp;&nbsp;</a>');
                $("#tab_9 #component-header").empty();
                $("#tab_9 #component-header").append(newHeader);
                $.each(result.Week1, function (i, item) {
                    var htmlStr = null;
                    if (jQuery.isEmptyObject(item)) {
                        ...
                        if (item.daycolumn == 0 || item.daycolumn == 6) {
                            htmlStr = $('<td class="weekend"></td>');
                            htmlStr.append('<a   id=' + item.dateStr + ' class="dt"><h3>' + (item.dtDay+" "+item.Content) + '</h3></a>');
                        }
