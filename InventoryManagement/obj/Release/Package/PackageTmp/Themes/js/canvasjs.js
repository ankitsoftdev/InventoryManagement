...
(function () {
    ...
    var themes =
		{
		    ...
		    "theme2": {
		        ...
		        Title: {
		            ...
		            fontSize: 8,//fontColor: "rgb(58,58,58)",
		            fontColor: "#333333",
    ...
    Axis.prototype.calculateAxisParameters = function () {
        ...
        if (this.type === "axisX") {
            ...
            else if (max - min === 0) {// When there is only a single dataPoint or when all dapoints have same Y Value
    ...
    CanvasJS.Chart.version = "v1.6.1 GA";
